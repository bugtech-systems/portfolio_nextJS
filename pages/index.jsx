...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log.apply(console, [
      "%c Designed and Developed by Steven Alba %c %c🚀 %c\n",
        ...
        <div className="lg:h-screen 2xl:h-max max-w-[90rem] mx-auto">
          <div className="flex flex-row justify-start items-center mt-20">
            ...
            <div className="flex flex-col ml-4">
              <h2 className="flex sm:text-2xl md:text-2xl lg:text-2xl">
                <span className="font-semibold">Steven Alba</span>
                <span>
                  <Image
          ...
          <div className="mt-12 text-base md:text-xl lg:text-xl xl:text-xl 2xl:text-xl">
            <p className="sm:leading-6 md:leading-6 lg:leading-8">
              I develop modern, reactive,
              and user-friendly web applications and also mobile applications using the latest technologies
              currently. Believe a perfect blend of user interface architecture
